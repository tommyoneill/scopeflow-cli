...
export async function refineVision(raw) {
    const prompt = `
...
export async function getPersonaNameOptions(raw, vision) {
    const prompt = `
...
export async function refinePersona(raw, vision, selectedName) {
    const prompt = `
...
export async function refineJobs(persona, raw, vision) {
    const prompt = `
...
export async function refineProblemSpace(input) {
    try {
        const messages = [
            {
                role: 'system',
...
export async function refineValueProposition(input) {
    try {
        const messages = [
            {
                role: 'system',
...
export async function refinePrinciples(input) {
    try {
        const messages = [
            {
                role: 'system',
...
export async function refineSolutions(input, options = {}) {
    try {
