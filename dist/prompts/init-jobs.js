import { text, select } from '../utils/prompts.js';
...
export async function handleJobsStep(personaName, personaContent, vision) {
    ...
    const jobs = await refineJobs(input, personaContent, vision);
    console.log('\n💡 Suggested Jobs:\n');
...
//# sourceMappingURL=init-jobs.js.map